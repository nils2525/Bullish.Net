...
namespace Bullish.Net.Interfaces.Clients.ExchangeApi
{
    ...
    public interface IBullishRestClientExchangeApiTrading
    {
        ...
        /// </summary>
        Task<HttpResult<BullishCreateOrderResult>> PlaceOrderAsync(string tradingAccountId, string symbol, BullishTradeSide side, BullishOrderType type, decimal quantity, BullishTimeInForce timeInForce, decimal? price = null, decimal? stopPrice = null, string? clientOrderId = null, bool? allowBorrow = null, bool? isMmp = null, CancellationToken ct = default);

        /// <summary>
        /// Cancel an order. <para><a href="https://docs.exchange.bullish.com/rest/api/command" /></para>
        /// </summary>
        Task<HttpResult<BullishCancelOrderResult>> CancelOrderAsync(string tradingAccountId, string symbol, string? orderId = null, string? clientOrderId = null, CancellationToken ct = default);

        /// <summary>
        /// Get current orders. <para><a href="https://docs.exchange.bullish.com/rest/api/get-orders-v-2" /></para>
        /// </summary>
        Task<HttpResult<BullishOrder[]>> GetOrdersAsync(string tradingAccountId, string? symbol = null, string? clientOrderId = null, BullishTradeSide? side = null, BullishOrderStatus? status = null, CancellationToken ct = default);

        /// <summary>
        /// Get an order by exchange order id. <para><a href="https://docs.exchange.bullish.com/rest/api/get-order-by-id-v-2" /></para>
        /// </summary>
        Task<HttpResult<BullishOrder>> GetOrderAsync(string tradingAccountId, string orderId, CancellationToken ct = default);
