...
namespace Bullish.Net.Interfaces.Clients.ExchangeApi
{
    ...
    public interface IBullishRestClientExchangeApiExchangeData
    {
        ...
        /// </summary>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<BullishSymbol[]>> GetSymbolsAsync(CancellationToken ct = default);
        ...
        /// </summary>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<BullishAsset[]>> GetAssetsAsync(CancellationToken ct = default);
        ...
        /// </summary>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<BullishTicker[]>> GetTickersAsync(CancellationToken ct = default);
